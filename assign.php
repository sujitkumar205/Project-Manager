...
<body>
    <nav id="mainNavbar" class="navbar navbar-dark navbar-expand-md py-0 fixed-top">
                        ...
                        <form action="" method="POST">
                          <legend>    
                            <fieldset>
                              ...
                              <h1 class="display-4 mb-2">Assign Task</h1>
                              ...
                              <div class="form-group">
                                <label class="mb-2" for="assign">Assign To</label>
                                  <div>
                                    <select id="assign" name="assign" class="custom-select" aria-label="Default select example">
      ...
      <?php include('PHP\assignTask.php') ?>
